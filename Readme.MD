...
[AWS Endpoint
](outputs/figures/aws_endpoint.png)
...
![Grafana Dashboard](outputs/figures/grafana-dashboard.png)
...
![AWS Endpoint](outputs/figures/aws_endpoint.png)
...
├── pipelines/sagemaker_pipeline.py
├── scripts/run_training_job.py + deploy_endpoint.py + test_endpoint.py
├── outputs/figures/grafana-dashboard.png
├── Makefile
└── requirements.txt
```
